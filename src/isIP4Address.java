 ...
 * each device (e.g., computer, printer) participating in 
 * a computer network that uses the Internet Protocol for 
 * communication. There are two versions of the Internet protocol,
 ...
 */
public class isIP4Address {
	boolean isIPv4Address(String inputString) {
		
		if(inputString.matches("\\A(25[0-5]|2[0-4]\\d|[0-1]?\\d?\\d)(\\.(25[0-5]|2[0-4]\\d|[0-1]?\\d?\\d)){3}\\z"))
			return true;
		else return false;
